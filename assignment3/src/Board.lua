...
function Board:initializeTiles()
    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            ...
            table.insert(self.tiles[tileY], Tile(tileX, tileY, math.random(18), math.random(self.highestVariety)))
    ...
    for x = 1, 8 do
        for y = 8, 1, -1 do
            ...
            if not tile then
                ...
                local tile = Tile(x, y, math.random(18), math.random(self.highestVariety))
                tile.y = -32
                self.tiles[y][x] = tile
